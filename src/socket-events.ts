...
export const onResponseGettingPlayers =
  (io: Server, socket: Socket) => (data: ReponseLoadingPlayer) => {
...
export const onPlayerStoreId =
  (socket: Socket, currentPlayer: Player) => (data: NetIdentity) => {
    currentPlayer.id = data.id;
  };
export const onRegisterPlayerFinished =
  (socket: Socket, currentPlayer: Player) =>
...
export const onRegisterPlayer2 =
  (socket: Socket) => (data: ClientRegistrar) => {
    // map ClientPlayer to Player
    console.log(
...
export const onRegisterPlayer =
  (socket: Socket, currentPlayer: Player, players: Player[]) =>
  (data: ClientPlayer) => {
    // map ClientPlayer to Player
...
//-- play
export const onPlay =
  (socket: Socket, currentPlayer: Player, playerList: Player[]) => () => {};
//--- player move
...
//--- player rotate
export const onPlayerRotate =
  (socket: Socket, currentPlayer: Player) => (data: Rotation) => {
...
//--- player flip
export const onPlayerFlip =
  (socket: Socket, currentPlayer: Player) => (data: Flip) => {
...
//--- player's eye move
export const onEyeMove =
  (socket: Socket, currentPlayer: Player) => (data: EyeMove) => {
...
//--- player's arm rotate
export const onArmRotate =
  (socket: Socket, currentPlayer: Player) => (data: ArmRotate) => {
...
//--- tank's head rotate
export const onHeadRotate =
  (socket: Socket, currentPlayer: Player) => (data: HeadRotate) => {
...
//--- player's max hp
export const onPlayerMaxHp =
  (socket: Socket, playerList: Player[]) => (data: Player) => {
    const dataCloned = DeepClone(data) as Player;
...
export const onWeaponTrigger =
  (socket: Socket, currentPlayer: Player) => (data: WeaponTrigger) => {
...
//--- register bullet
export const onBulletRegister =
  (socket: Socket, bullets: Bullet[]) => (data: Bullet) => {
    const bulletCloned = DeepClone(data);
    // emit to another clients the current player registered successfully
    socket.broadcast.emit(EVENT_CLIENT_BULLET_OTHER_REGISTERED, bulletCloned);
  };
//--- Remove bullet.
export const onBulletRemove =
  (socket: Socket, bullets: Bullet[]) => (data: NetIdentity) => {
    const dataCloned = DeepClone(data);
...
export const onPlayerBreakPressDown =
  (socket: Socket) => (data: NetIdentity) => {
    const dataCloned = DeepClone(data);
    socket.broadcast
      .to(SERVER)
...
export const onFodderSendGettingAll =
  (io: Server, socket: Socket) => (data: FodderFetching) => {
    const dataCloned = DeepClone(data) as FodderFetching;
    io.to(dataCloned.socketId).emit(EVENT_FODDER_FETCHING, dataCloned);
  };

export const onFodderRemove =
  (io: Server, socket: Socket) => (data: NetIdentity) => {
    const dataCloned = DeepClone(data) as NetIdentity;
